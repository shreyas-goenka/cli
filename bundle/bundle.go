...
// RecordsDeploymentHistory reports whether this bundle records deployment history with the
// deployment metadata service, from experimental.record_deployment_history or
// DATABRICKS_BUNDLE_RECORD_DEPLOYMENT_HISTORY.
func (b *Bundle) RecordsDeploymentHistory(ctx context.Context) bool {
